...
### Новые файлы
- `path/to/NewFile.cs` (или `path/to/NewFile.java`) — [назначение файла]

### Изменения в существующих файлах

#### Файл: `path/to/ExistingFile.cs` (или `path/to/ExistingFile.java`)
...
**Пример:**
```markdown
#### Файл: `src/services/PaymentService.cs` (или `src/services/PaymentService.java`)
